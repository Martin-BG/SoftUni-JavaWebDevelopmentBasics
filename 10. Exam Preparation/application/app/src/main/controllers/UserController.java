...
/*        if(userLoginBindingModel == null || userLoginBindingModel.getUsername() == null || userLoginBindingModel.getPassword() == null ) {//NOTE - implemented BindingResult (errors) class
            return super.error(model, bindingResult);
            return super.view(request,model, "login");
        }*/
...
/*        if(userRegisterBindingModel == null || userRegisterBindingModel.getUsername() == null  //NOTE - implemented BindingResult (errors) class
