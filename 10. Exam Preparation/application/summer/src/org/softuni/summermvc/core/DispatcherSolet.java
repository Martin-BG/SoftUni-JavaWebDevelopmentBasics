...
public class DispatcherSolet extends BaseHttpSolet {
        ...
        ControllerActionPair candidateControllerActionPair = this.controllerLoadingService.getLoadedControllersAndActions()
                ...
                .filter(action -> {
                    ...
                    if(routeMatcher.find()) {
                        ...
                        return true; // NOTE - returns false instead of true
                    } else {
                        return false;
                    }
                })
    ...
    public void service(HttpSoletRequest request, HttpSoletResponse response) {
        ...
        this.dependencyContainer.addInstantiatedObject(BindingResult.class.getSimpleName(), new BindingResult()); //NOTE - implemented BindingResult (errors) class

        super.service(request, response);

        this.dependencyContainer.evictCachedStaticStates();

        this.dependencyContainer.evictInstantiatedClasses(); //NOTE - Added clear instantiated classes logic
    }
