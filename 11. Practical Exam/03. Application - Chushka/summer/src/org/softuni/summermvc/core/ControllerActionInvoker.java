...
//Greetings fellow developer. You have encountered a bugged class,
//which many have failed to fix before you. You can try your best.
//And I wish you good luck. But just do me one favour. Increase the counter of hours,
//when you fail, so that the next developer will know just how much time was
//wasted trying to fix this.
...
public class ControllerActionInvoker {
    ...
    public Object invokeAction(ControllerActionPair cap) throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, InstantiationException {
        ...
        cap.clearParameters(); // NOTE - this was missing
